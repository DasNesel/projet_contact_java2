...
public class ContactDao {
    ...
    public List<Contact> getContactsByNickname(String searchName) {
        /*
         * Function use to get the list of the contacts
         * Return : List<Contact> with all the contact in the database
         */
        ...
        DataSource db = DataSourceFactory.getDataSource();
        try(Connection connection = db.getConnection()) { // connection to the database
            String sqlQuery = "SELECT * FROM contact WHERE nickname = ? "; // requete SQL
            try(PreparedStatement statement = connection.prepareStatement(sqlQuery)){
    ...
    public List<Contact> getContactsByFirstname(String searchName) {
        /*
         * Function use to get the list of the contacts
         * Return : List<Contact> with all the contact in the database
         */
        ...
        DataSource db = DataSourceFactory.getDataSource();
        try(Connection connection = db.getConnection()) { // connection to the database
            String sqlQuery = "SELECT * FROM contact WHERE firstname= ? "; // requete SQL
            try(PreparedStatement statement = connection.prepareStatement(sqlQuery)){
    ...
    public List<Contact> getContactsByPhoneNumber(String searchName) {
        /*
         * Function use to get the list of the contacts
         * Return : List<Contact> with all the contact in the database
         */
        ...
        DataSource db = DataSourceFactory.getDataSource();
        try(Connection connection = db.getConnection()) { // connection to the database
            String sqlQuery = "SELECT * FROM contact WHERE phone_number_fix = ? OR phone_number_mobil = ? "; // requete SQL
            try(PreparedStatement statement = connection.prepareStatement(sqlQuery)){
                statement.setString(1, searchName);
